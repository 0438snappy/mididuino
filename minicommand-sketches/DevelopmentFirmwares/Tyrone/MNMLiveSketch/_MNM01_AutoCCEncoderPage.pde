...
//    /*
//    *  NOTE 19/01/2013:  Didn't really find the FWD/REV/PENDULUM/ONESHOT functionality that useful so have commented it out for now.  May come back to it later.
//    */     
//    uint8_t endPoint = encoder->recordingLength - 1;
//    
//    // Reverse Playback
...
//      /*
//      *
//      *  PLAYBACK DIRECTION - cycle through forward / reverse / pendulum by pressing button 3 + encoder
//      *
//      */     
//      if (BUTTON_DOWN(Buttons.BUTTON3)) {
//          for (uint8_t i = Buttons.ENCODER1; i <= Buttons.ENCODER4; i++) {
//              if (EVENT_PRESSED(event, i)) {
//                  recEncoders[i].incrementPlaybackMode();
//                  char *playbackModeName;
//                  switch(recEncoders[i].playbackMode){
//                      case REC_ENC_PLAYBACK_REVERSE:
//                          playbackModeName = "REVERSE";
//                          break;
//                                     
//                      case REC_ENC_PLAYBACK_PENDULUM:
//                          playbackModeName = "PENDULUM";
//                          break;
//                                  
//                      // REC_ENC_PLAYBACK_FORWARD
//                      default:
//                          playbackModeName = "FORWARD";
//                          break;
//                  }                  
//                  char *encoderName;
//                  encoderName = "ENC X PLAYBACK:";
...
//                  GUI.flash_string_fill(encoderName);               
//                  GUI.setLine(GUI.LINE2);
//                  GUI.flash_string_fill(playbackModeName);
//              }
//          }
//      }
//      
//      /*
//      *
//      *  PLAYBACK LOOP / ONE SHOT - toggled by pressing button 4 + encoder
//      *
//      */     
//      if (BUTTON_DOWN(Buttons.BUTTON4)) {
//          for (uint8_t i = Buttons.ENCODER1; i <= Buttons.ENCODER4; i++) {
//              if (EVENT_PRESSED(event, i)) {
//                  recEncoders[i].loopPlayback = !recEncoders[i].loopPlayback;                  
//                  GUI.setLine(GUI.LINE1);
//                  char *encoderName;
//                  encoderName = "ENC X PLAYBACK:";
//                  encoderName[4] = '0' + i + 1;
//                  GUI.flash_string_fill(encoderName);               
//                  GUI.setLine(GUI.LINE2);
//                  if (recEncoders[i].loopPlayback){
//                      GUI.flash_string_fill("LOOPING");
//                  } else {
//                      GUI.flash_string_fill("ONE SHOT");                    
//                  }
//              }
//          }
//      }
